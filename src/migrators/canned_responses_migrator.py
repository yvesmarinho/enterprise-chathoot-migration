...
class CannedResponsesMigrator(BaseMigrator):
    ...
    def migrate(self) -> MigrationResult:
        ...
        try:
            ...
            self.logger.warning(
                "CannedResponsesMigrator: DEST public.canned_responses missing — bootstrapping from SOURCE"
            )
            ensure_public_table_exists(self.source_engine, self.dest_engine, "canned_responses")
            dest_table = Table("canned_responses", dest_meta, autoload_with=self.dest_engine)
