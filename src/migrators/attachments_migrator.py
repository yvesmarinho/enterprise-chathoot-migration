...
class AttachmentsMigrator(BaseMigrator):
    ...
    def migrate(self) -> MigrationResult:
        ...
        try:
            ...
            self.logger.warning(
                "AttachmentsMigrator: DEST public.attachments missing — bootstrapping from SOURCE"
            )
            ensure_public_table_exists(self.source_engine, self.dest_engine, "attachments")
            dest_table = Table("attachments", dest_meta, autoload_with=self.dest_engine)
